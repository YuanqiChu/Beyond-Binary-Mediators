...
# inside 02_bmeop_model.R (this folder) or 02_bjcm_model.R (MH_BJCM). That keeps them available to
# 03a_run_reduced_check.R, 03c_run_full_model.R, and the diagnostics/table scripts in this folder
# without any of those three ever needing to source() both model files
# together (see 03a_run_reduced_check.R's header comment for why that's avoided).
#
# Source this file at the top of any script that calls run_in_background()
# or monitor_progress() or collect_result() - 08a/08b/08c all do this.
# =============================================================================
